...
//   include_once("admin/data/Comment.php");
 ...
 <?php 
  ...
  ?>
		...
		<div class="container">
			...
			<section class="blog-section">
				...
				<main class="main-blog">
					...
					<button id="show-all-btn" class="btn btn-success rounded">Show All</button>
    				<button id="show-less-btn" class="btn btn-success rounded" style="display:none;">Show Less</button>
				</main>
				<?php }else{
	...
	// For show all and show less functionality
	document.addEventListener('DOMContentLoaded', function() {
		const parentElement = document.querySelector('.main-blog .row');
